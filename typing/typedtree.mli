...
and exp_extra =
  ...
  | Texp_open of override_flag * Path.t * Longident.t loc * Parsetree.open_hiding list * Env.t
...
and structure_item_desc =
  ...
  | Tstr_open of override_flag * Path.t * Longident.t loc * Parsetree.open_hiding list
...
and signature_item_desc =
  ...
  | Tsig_open of override_flag * Path.t * Longident.t loc * Parsetree.open_hiding list
